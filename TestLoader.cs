...
{
    readonly static string measurementsUrl = "https://raw.githubusercontent.com/radekdoulik/WasmPerformanceMeasurements/main/measurements/index.zip";
    ...
    internal static async Task<string> loadTests()
    {
        ...
        var bytes = await querySolver.solveQueryByte(measurementsUrl);
